...
const About = () => {
  return (
    <main className="font-sans">
      {/* Hero Section */}
      <section 
        className="relative w-full text-white py-28 px-6 text-center overflow-hidden bg-cover bg-center bg-no-repeat"
      ...
      >
        ...
        <div className="relative z-10 max-w-[900px] mx-auto">
          <span className="inline-block px-5 py-[0.35rem] rounded-full bg-[#d32f2f]/80 border border-[#d32f2f] text-[0.8rem] font-bold tracking-[2px] uppercase text-white mb-6 shadow-sm">
            Our Mission & Vision
          </span>
          <h1 className="text-[2.2rem] sm:text-[clamp(2.5rem,5vw,4rem)] font-black leading-[1.1] mb-6 tracking-[-1px] drop-shadow-lg">
            Empowering Minds, Shaping the Future
          </h1>
          <p className="text-[clamp(1.1rem,1.5vw,1.25rem)] text-white/95 max-w-[700px] mx-auto leading-[1.8] drop-shadow-md font-medium">
