    ...
    <>
      ...
      <main className="font-sans bg-[var(--color-surface)] min-h-screen">
        ...
        >
          ...
          <h1 className="relative z-10 text-[2.2rem] sm:text-[clamp(2.5rem,5vw,4rem)] font-black leading-[1.1] mb-4 drop-shadow-lg">
            Contact Akshar Academy
          </h1>
          <p className="relative z-10 text-[clamp(1.05rem,1.5vw,1.2rem)] text-white/90 max-w-[37.5rem] mx-auto leading-[1.7] font-medium drop-shadow-md">
